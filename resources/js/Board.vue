<template>
    <div class="h-full flex flex-col items-stretch bg-purple-500">
        ...
        >
            ...
            <div class="text-lg opacity cursor-pointer hover:opacity-75">Laravello</div>
        ...
        <div class=" h-full flex flex-1 flex-col items-stretch">
            ...
            <div class="flex flex-1 items-start overflow-x-auto mx-2">
                <div class="bg-gray-300 rounded-sm p-2 mr-2 list">
                    ...
                    <div class="card bg-white rounded-sm p-2 cursor-pointer text-sm hover:bg-gray-100 mb-2">xxx</div>
                    <div class="card bg-white rounded-sm p-2 cursor-pointer text-sm hover:bg-gray-100 mb-2">xxx</div>
                    <div class="card bg-white rounded-sm p-2 cursor-pointer text-sm hover:bg-gray-100 mb-2">xxx</div>
